...
if get_accelerator().name == "cuda":
    ...
    def is_flash_attn(cls):
        return True
    
    def replace_pipeline() -> None:
        from colossalai.shardformer.modeling.llama import LATEST_VERSION, LlamaPipelineForwards
        LlamaPipelineForwards._prepare_decoder_attention_mask = MethodType(_prepare_decoder_attention_mask, LlamaPipelineForwards)
        LlamaPipelineForwards.is_flash_attn = MethodType(is_flash_attn, LlamaPipelineForwards)
